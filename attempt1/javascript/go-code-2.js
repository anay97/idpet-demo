  function init2() {
    if (window.goSamples) goSamples();  // init2 for these samples -- you don't need to call this
    var $ = go.GraphObject.make;

    myDiagram =
      $(go.Diagram, "sequence-diagram", // must be the ID or reference to an HTML DIV
        {
